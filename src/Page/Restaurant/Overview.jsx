        ...
        <div className="w-full md:w-8/12">
          ...
          <div className="flex justify-between items-center">
            ...
            <Link to={`/restaurant/${id}/menu`}>
              <span className="flex items-center gap-1 text-yummilicious-400">
                See all menu <IoMdArrowDropright />
              </span>
            </Link>
          </div>
          <div className="flex flex-wrap gap-3">
            <MenuCollection image={menuImage} menuTitle="Menu" pages="4" />
          </div>
          <div>
          ...
          <div>
            <h4 className="text-bold text-gray-800 text-xl">
