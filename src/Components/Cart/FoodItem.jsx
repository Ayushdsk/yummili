      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col gap-1 items-end">
            ...
            <div className="flex items-center bg-yummilicious-400 px-2 gap-2 rounded-lg">
              <button
                onClick={decrement}
                className="text-white bg-yummilicious-400 p-1 rounded-lg"
              >
                -
              </button>
          ...
          <BsTrashFill
            ...
            className="text-yummilicious-400 text-lg md:text-xl"
          />
        </div>
      </div>
      <hr className="my-1" />
