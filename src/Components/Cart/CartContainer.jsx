  ...
  return (
    <>
      <div className="md:hidden flex items-center justify-between">
        ...
        <button className="bg-yummilicious-400 px-3 py-1 gap-1 text-white flex items-center rounded-lg">
    ...
    <>
      <div className="hidden md:flex items-center justify-between container px-20 mx-auto">
        <div className="flex items-center gap-3 items-start">
          <span
            onClick={toggle}
            className="border border-gray-400 rounded-sm text-2xl"
            onClick={toggle}
          >
            <IoMdArrowDropup />
          </span>
          <small className="text-xl">Your Order ({reduxState.length})</small>
        </div>
        <div className="flex items-center text-xl gap-2">
          ...
          <button
            ...
            className="bg-yummilicious-400 px-5 py-1 gap-1 text-white flex items-center rounded-md"
          >
            Continue <IoMdArrowDropright />
          </button>
        </div>
