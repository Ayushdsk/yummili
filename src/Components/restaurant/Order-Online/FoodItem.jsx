        ...
        <div className="flex items-start lg:gap-2 mt-2 ">
          ...
          <div className="w-8/12 md:3/6 mt-2 flex flex-col gap-1">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className=" md:hidden flex h-8 w-17 items-center font-bold text-yummilicious-400 bg-yummilicious-50 border border-yummilicious-400 px-2 py-1 rounded-lg"
              >
                {food.isAddedToCart ? (
                  "Added"
                ) : (
          ...
          <div className="hidden md:block w-2/12 ">
            <button
              onClick={addFoodToCart}
              disabled={food.isAddedToCart}
              className=" flex h-8 w-17 items-center font-bold text-yummilicious-400 bg-yummilicious-50 border border-yummilicious-400 px-4 py-2 rounded-lg"
            >
              {food.isAddedToCart ? (
                "Added"
              ) : (
